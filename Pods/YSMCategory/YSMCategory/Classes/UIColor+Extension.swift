...
extension UIColor{
    ...
    ///
    /// - Returns: <#return value description#>
    public func getRGBComponents() -> (r:CGFloat,g:CGFloat,b:CGFloat,alpha:CGFloat) {
    ...
    /// - Returns: <#return value description#>
    public class func getRGBDelta(_ sourceColor:UIColor,_ targetColor:UIColor) -> (rDelta:CGFloat,gDelta:CGFloat,bDelta:CGFloat,aDelta:CGFloat) {
